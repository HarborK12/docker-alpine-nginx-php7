...
RUN mkdir /conf.d \
    ...
    && curl -o /usr/lib/php7/modules/blackfire-php-alpine_amd64-php-70.so https://packages.blackfire.io/binaries/blackfire-php/1.16.1/blackfire-php-alpine_amd64-php-70.so \
